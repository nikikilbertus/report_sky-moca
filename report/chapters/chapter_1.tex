...
We are going to use \newterm{simulated annealing}. The name already hints
towards thermodynamic processes, which we already identified as a key feature of
our system, but were not yet able to bake it into our model. \todo{describe it
generally, think about how and when to link to our concrete use case}
