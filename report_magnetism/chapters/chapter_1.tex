...
interaction only, as shown in \figref{fig:lattice}. In the continuum theory, the
...
Dzyaloshinskii-Moriya} (DM) coupling is proportional to
\begin{equation}
...
interaction}, which, although rather weak, commonly plays an important role, but
...
interactions, see \figref{fig:interact}.
...
transitions when analyzing the results in \chapref{chap:2}.
